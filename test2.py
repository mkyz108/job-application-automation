...
if __name__ == "__main__":
    # Input: Tasks for the day and emails to summarize
    user_inputs = {
        "tasks": "Complete project report, Attend team meeting at 2 PM, Prepare presentation for Friday, Respond to client emails.",
        "emails": "1. Email from manager: Submit report by EOD.\n2. Client email: Schedule a call next Monday.\n3. Team email: Feedback on the recent project."
    }

    # Execute the crew
    result = crew.kickoff(inputs={
        "tasks": user_inputs["tasks"],
        "emails": user_inputs["emails"]
    })
